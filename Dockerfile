...
RUN apt-get update
RUN apt-get install libpixman-1-dev libcairo2-dev libpango1.0-dev libjpeg8-dev libgif-dev
...
ENV REACT_APP_STORE_OWNER_ADDRESS_ADDRESS="2Eij79wcx2mun8buKTVTQkvDCjUisxcx9g9DBXMVraxe"
